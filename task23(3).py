...
btn_open = tk.Button(fr_bg1, text="Open file", bg='Medium Blue', fg='white', font=('helvetica', 12, 'bold'),
...
btn_merge = tk.Button(fr_bg2, text="Merge PDF", bg='Medium Blue', fg='white', font=('helvetica', 12, 'bold'),
                      state="disabled",
                      command=lambda: merge_pdfs(filelist))
btn_merge.grid(row=2, column=0, sticky="ew", padx=5, pady=5)
fr_bg2.pack()

btn_exit = tk.Button(window, text="Exit", command=window.destroy, bd=2, bg='Medium Blue', fg='black',
